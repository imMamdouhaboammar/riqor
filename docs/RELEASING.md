...
The workflow requires `id-token: write`, a GitHub-hosted runner, Node.js 22.14 or newer, and npm 11.5.1 or newer. The repository pins npm 11.18.0 for release jobs.
