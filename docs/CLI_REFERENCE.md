...
These commands operate on the current repository or Riqor local state. They are part of the `0.2.0` CLI surface and return structured JSON when `--json` is supported.
